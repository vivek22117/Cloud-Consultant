...
const API_ENDPOINT = 'https://v06xz2qmvi.execute-api.us-east-1.amazonaws.com/dev/messages';
...
// document.getElementById('request-form').addEventListener('submit', reset_form);
